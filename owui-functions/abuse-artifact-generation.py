...
def is_final_answer(message: str) -> bool:
    return final_answer in message or any(
        [word in message.lower() for word in detect_final]
    )
...
class Pipe:
    ...
    async def pipe(
        ...
        messages = [
            ...
            {"role": "user", "content": "Provide the first step."},
        ]
...
### url https://raw.githubusercontent.com/av/harbor/refs/heads/main/open-webui/extras/artifact.py
